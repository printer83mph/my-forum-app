  ...
  return (
    <main className="container max-w-2xl mx-auto mt-6 px-3 mb-4">
      <div className="flex items-center justify-center mb-4">
        <div
          className="w-20 h-20 aspect-square bg-cover bg-center rounded-full mr-5"
          title="swapneel my beloved"
          style={{ backgroundImage: `url('${swapUrl}')` }}
        >
          <span className="sr-only">swapneel my beloved</span>
        </div>
        <h1 className="text-3xl font-bold tracking-tight">
          197 Forum Hub Discussions Central
        </h1>
      </div>
      <div className="mb-4">
        <NewMessage
